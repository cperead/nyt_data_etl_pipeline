# NYTDataPipeline: <br> Building a Data Pipeline for Extracting, Transforming, and Loading New York Times Data


---
## Introduction
The purpose of this project create a data pipeline that can query a SQLite database based on the results of querying the New York Times Archive API using FastAPI. This API will be composed of 5 query-endpoints. The endpoints at first are intended to test the normalized author's information.

---
# ETL Pipeline Overview
The "NYTDataPipeline" is a **Data Engineering** project that involves building a data **pipeline** for **extracting**, **transforming**, and **loading** New York Times Archive data.   
...
For this reason, all the endpoints are concentrated on querying the author and inserting one article with the author(s), and then to check if it was succesfully created.  
